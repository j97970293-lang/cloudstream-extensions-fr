...
internal data class NuvioFrenchTmdbCard(
    val id: Int,
    val type: String,
    val title: String,
...
internal object NuvioFrenchTmdb {
    ...
    suspend fun catalog(path: String, page: Int): List<NuvioFrenchTmdbCard> {
    ...
    suspend fun search(query: String): List<NuvioFrenchTmdbCard> {
    ...
    private fun JSONArray.toCards(typeHint: String?): List<NuvioFrenchTmdbCard> {
