...
internal data class FrenchHubTmdbCard(
    val id: Int,
    val type: String,
    val title: String,
...
internal object FrenchHubTmdb {
    ...
    suspend fun catalog(path: String, page: Int): List<FrenchHubTmdbCard> {
    ...
    suspend fun search(query: String): List<FrenchHubTmdbCard> {
    ...
    private fun JSONArray.toCards(typeHint: String?): List<FrenchHubTmdbCard> {
